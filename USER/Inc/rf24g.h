...
#define NRF24L01_SPI_CS_CLK_ENABLE()                  __HAL_RCC_GPIOE_CLK_ENABLE()
#define NRF24L01_SPI_CS_PORT                          GPIOE
...
#define NRF24L01_CE_CLK_ENABLE()                      __HAL_RCC_GPIOE_CLK_ENABLE()
...
uint8_t NRF24L01_TxPacket_Data(uint8_t *txbuf, uint8_t len); // 发送一个指定长度的数据包
